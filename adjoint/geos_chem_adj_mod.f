...
! add TROPOMI L2 NO2 (zhendlu, 07/11/20)
#if defined (TROPOMI_NO2_OBS)
      Use TROPOMI_NO2_OBS_MOD,  ONLY : CALC_TROPOMI_NO2_FORCE
#endif
...
!      ENDIF
      ...
      CALL CALC_TROPOMI_NO2_FORCE(COST_FUNC)
      
      ! Track cost function contributions
      CF_TROPOMI_NO2 = CF_TROPOMI_NO2 + COST_FUNC - CF_PRIOR
