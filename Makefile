...
GC_INCLUDE := /home/whdong/Libraries/netcdf_4.2.1.1/include
...
NCL := $(shell nf-config --flibs)
NCL += $(shell nc-config --libs)
NCL       := $(filter -l%,$(NCL))
...
GC_LIB := /home/whdong/Libraries/netcdf_4.2.1.1/lib
NCL       := -L$(GC_LIB) $(NCL)
LINK      := $(NCL)

ifeq ($(USE_MKL),yes)
LINK	+= -L$(MKLROOT)/lib/em64t  $(MKLROOT)/lib/intel64/libmkl_blas95_lp64.a  $(MKLROOT)/lib/intel64/libmkl_lapack95_lp64.a -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -qopenmp -lpthread
...
# NETCDF
#FFLAGS += -I/opt/apps/netcdf-fortran/4.4.4_parallel_studio-2017.4/include
#LINK += -L/opt/apps/netcdf-fortran/4.4.4_parallel_studio-2017.4/lib -lnetcdff
...
LIDORT_COMPILE_FIXED = ifort -cpp -check bounds -O3 -zero  -noalign -fixed -qopenmp -Dmultitask
LIDORT_COMPILE       = ifort -c -check bounds -O3 -zero  -noalign -free -qopenmp -Dmultitask -traceback -CB -vec-report0
...
# OMPS NO2
#====================
omps_no2_obs_mod.o   : omps_no2_obs_mod.f
	 $(F90) -c -r8 obs_operators/omps_no2_obs_mod.f

#====================
# OSSE NO2
#====================
osse_no2_obs_mod.o   : osse_no2_obs_mod.f90
	 $(F90) -c -r8 obs_operators/osse_no2_obs_mod.f90

#====================
# TROPOMI NO2
#====================
tropomi_no2_obs_mod.o   : tropomi_no2_obs_mod.f90
	 $(F90) -c -r8 obs_operators/tropomi_no2_obs_mod.f90

#====================
# netCDF
#====================
netcdf_mod.o        : netcdf_mod.f90
	 $(F90) -c -r8 obs_operators/netcdf_mod.f90
